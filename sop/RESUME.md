...
- Circuit breaker: ACTIVE (drawdown 15.19% ≥ 12%)
- Last updated: 2026-07-22 15:57 UTC (10:57 CT)

## Account Snapshot
- Total value: $84.01
- Cash: $44.01
- Options exposure: $40.00 (1× T Jul31 $23C mark $0.400)
- 15% cash floor: $14.86 (15% of $99.05)
- Buying power: $44.01
- Drawdown from session start: 15.19% → CB ACTIVE

## Open Positions
| Ticker | C/P | Strike | Expiry | DTE | Qty | Cost/sh | Mark | P&L% | IV | Tag |
|--------|-----|--------|--------|-----|-----|---------|------|------|----|-----|
| T | C | $23 | 2026-07-31 | 9 | 1 | $0.55 | $0.400 | −27.27% | 0.320 | POST-EARN |
...
### SESSION STATE
- session_start_value: $99.05. CB ACTIVE (drawdown 15.19% ≥ 12%). min_cash_floor: $14.86. max_cost: $29.15.
- Cash $44.01, 1 open position (T Jul31 $23C), 0 pending orders.
- CB lift threshold: total_value must exceed $87.164 (drawdown < 12%). Options mark needs to recover above $0.432/share.
- Current mark $0.40 — $0.032 below CB lift threshold (8% recovery needed).

### T POSITION — HOLD (no exits triggered)
- T Jul31 $23C, qty 1, opened 2026-07-22 14:15:31 UTC
- Cost/sh: $0.55. Mark: $0.400. P&L: −27.27%
- option_id: 2fc41dc8-6305-46ce-8df0-8dfb985eed45
- Tag: POST-EARN (SCAN A Pass 1 — T beat +10.2%, $0.65 vs $0.59 est)
- Exit rules: pnl ≥75% take profit | pnl ≤−40% stop loss (~$0.33/share) | DTE≤2 | catalyst reversed
- Current P&L −27.27%: none of (a)-(d) triggered → HOLD
- DTE 9 days (Jul 31 expiry) — no time decay urgency
- IV 0.320, delta 0.464, theta −0.0262/day, OI 4406, vol 3778
...
- TLT $83P Jul 31 (id: a23bfb72-1ee4-4d94-9c28-b0706b5cc33) — ALL gates PASS except cost:
...
1. STEP 5: Re-quote T Jul31 $23C (id: 2fc41dc8). Check exits (a)-(d). P&L −27.27% — stop loss triggers at ≤−40% (~$0.33/share).
2. STEP 4: CB ACTIVE (15.19%). Lift requires total_value > $87.164 (mark > $0.432). Currently $0.032 below threshold.
...
[15:57 UTC] TICK — STEP 2: total_value $84.01, cash $44.01, options $40.00. STEP 3: T Jul31 $23C confirmed, mark $0.400, P&L −27.27%. STEP 4: CB ACTIVE — drawdown 15.19% ≥ 12% (deepened; threshold $87.164, current $84.01). STEP 5: T exits — (a) ≥75%: NO (b) ≤−40%: NO ($0.33 threshold not hit) (c) DTE=9: NO (d) NO → HOLD. STEP 6: SKIPPED — CB active. No new trades.
