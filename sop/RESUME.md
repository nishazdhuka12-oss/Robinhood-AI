...
- Circuit breaker: ACTIVE (drawdown 15.9% ≥ 12%)
- Last updated: 2026-09-08 18:58 UTC

## Account Snapshot
- Total value: $26.73
- Cash: $6.73
- Options exposure: $20.00 (TLT $82.5C Sep 11 x1)
- 15% cash floor: $4.77 (15% of $31.77)
- Drawdown from session start: 15.9% ($5.04)

## Open Positions
| Ticker | C/P | Strike | Expiry | DTE | Qty | Cost | Mark | P&L% | IV | Tag |
|--------|-----|--------|--------|-----|-----|------|------|------|----|-----|
| TLT | C | $82.5 | 2026-09-11 | 3 | 1 | $0.25 | $0.190 | -24% | 0.133 | SWING |
...
## Carry-Forward
1. TLT $82.5C 9/11 DTE=3 cost=$0.25 mark=$0.190 P&L=-24% IV=0.133 SWING | CPI Sep 11
2. CB ACTIVE: drawdown=15.9% ($31.77→$26.73). No new trades until next day reset.
...
5. BRZE/CASY/AVO/TTAN/INNV report Sep 8 PM — check beats next tick (CB blocks anyway).
...
[18:40 UTC] S6: ScanA POST all fail/budget. PRE-IV FDX tentative budget-fail. ScanD ONE ETF held. NO TRADE.
[18:58 UTC] S2: total=$26.73 drawdown=15.9% CB TRIPPED (≥12%). S5: TLT mark=$0.190 P&L=-24% DTE=3. HOLD.
