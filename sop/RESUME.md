...
- Total value: $147.11
- Cash: $24.11
- Options exposure: $123.00 (KEY $23C 8/21 × 1, last mark $1.23 — STALE, Friday close)
...
- Cost: $1.30/sh ($130 total). Last mark (stale): $1.23. P&L ~-5.4%.
- KEY reports Jul 21 AM. days_to_report = 1 → SWING-EARN eval ACTIVE every tick today.
- **PULL FRESH QUOTE AT 8:30 AM CT OPEN — do not use stale pre-market data for SWING-EARN eval.**
...
- Last known: IV 32.2% (well below 0.80), delta 0.627 (≥0.55), P&L -5.4% (<15%) → hold-through criteria met pending fresh data.
