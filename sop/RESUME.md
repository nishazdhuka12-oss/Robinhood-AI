...
Last updated: 2026-06-24 11:35 AM CDT (market open). See sop/SKILL.md for the full current framework — Path 0/B/C/D with catalyst tiers, opening-range breakout, VWAP, Hold-vs-Sell decision tree, profit-locking, SPY/QQQ tape rules.

## OPEN PATH D POSITION — DFTX (bought 9:21 AM CDT 2026-06-24)

Filled: 0.33862 sh @ $43.47. Now $43.97 (+1.15%), below +7% profit-lock threshold — holding. Confirmed Tier 1 catalyst still active (Phase 3 trial, day 3). **Must close by 3:00 PM CDT regardless of P&L (Hard Rule 29).** Running Hold-vs-Sell Q1-Q8 + profit-locking ladder every tick until then.

RYAN (legacy) at $35.41, 70¢ from its $36.11 trigger, watch closely.
