...
| Ticker | Cost Basis | High Water Mark | Trailing Stop Level | Partial Taken | Notes |
|---|---|---|---|---|---|
| BB | ~10.61 | 10.61 | n/a (day-trade, EOD force-close 3:00 PM CDT, not trailing-stop managed) | no | Bought 2026-06-25 9:22 AM CDT, $14.79 notional (1.39396 sh), order id 6a3d3984-3e56-4d55-abe4-efd99c2a8e9c, state unconfirmed pending fill. Confirmed Tier 1 catalyst: Q1 earnings double beat (EPS 4¢ vs 3¢ est, revenue +26% YoY) + raised FY guidance, first cash-positive quarter in 9 years — via Benzinga + CNBC. Entered after a clean, orderly 2-bar breakout (higher highs $10.50→$10.64, higher lows $10.19→$10.49) on sustained volume (804K-899K/bar), not a violent spike. Must close by 3:00 PM CDT regardless of P&L (Hard Rule 29) — apply Hold-vs-Sell Q1-Q8 loop and profit-locking ladder (+7%→floor+4%, +12%→sell half, +15%+→sell all) each tick until then. |
