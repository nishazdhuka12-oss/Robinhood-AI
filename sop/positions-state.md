...
| FPS | 60.48 | 61.48 | 51.41 | no | Filled 2026-06-16 ~10:48 AM ET (actual fill $60.48). Trailing activates at +10% ($66.53). Signal: Path F user watchlist. Data center power equipment, 103% YoY growth. HWM updated 2026-06-16 ~8:19 PM ET (AH print). |
| DRAM | 70.15 | 71.97 | 59.63 | no | Filled 2026-06-16 ~10:48 AM ET (actual fill $70.15). Trailing activates at +10% ($77.17). Signal: Path F user watchlist. Roundhill Memory ETF — AI/memory semiconductor theme. YELLOW sizing (×0.75). HWM updated 2026-06-17 ~9:04 AM ET (pre-mkt print $71.97, 8th HWM update overnight). |
