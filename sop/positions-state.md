...
| DRAM | 70.15 | 77.51 | 72.51 | no | Filled 2026-06-16 ~10:48 AM ET (actual fill $70.15). **TRAILING ACTIVE** — crossed +10% threshold 2026-06-18 ~10:16 AM CDT. New HWM 2026-06-18 ~1:24 PM CDT (exchange print $77.51, +10.49% vs cost). Trailing stop = HWM - $5.00 = $72.51 (sells if price falls to/below this). Signal: Path F user watchlist. Roundhill Memory ETF — AI/memory semiconductor theme. YELLOW sizing (×0.75). |
