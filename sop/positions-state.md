...
| DRAM | 70.15 | 77.12 | 59.63 | no | Filled 2026-06-16 ~10:48 AM ET (actual fill $70.15). Trailing activates at +10% ($77.17). Signal: Path F user watchlist. Roundhill Memory ETF — AI/memory semiconductor theme. YELLOW sizing (×0.75). HWM updated 2026-06-18 ~9:58 AM CDT (exchange print $77.12, +9.93% vs cost — still just 4.5 cents below +10% threshold, watch closely). |
