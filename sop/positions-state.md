...
| DRAM | 70.15 | 72.04 | 59.63 | no | Filled 2026-06-16 ~10:48 AM ET (actual fill $70.15). Trailing activates at +10% ($77.17). Signal: Path F user watchlist. Roundhill Memory ETF — AI/memory semiconductor theme. YELLOW sizing (×0.75). HWM updated 2026-06-17 ~3:20 AM ET (pre-mkt print $72.04, 9th HWM update overnight). |
