...
| DRAM | 70.15 | 71.80 | 59.63 | no | Filled 2026-06-16 ~10:48 AM ET (actual fill $70.15). Trailing activates at +10% ($77.17). Signal: Path F user watchlist. Roundhill Memory ETF — AI/memory semiconductor theme. YELLOW sizing (×0.75). HWM updated 2026-06-17 ~8:44 AM ET (pre-mkt print $71.80, +5.47% vs Jun16 close, 7th HWM update overnight). |
