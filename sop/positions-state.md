...
| DRAM | 70.15 | 75.40 | 59.63 | no | Filled 2026-06-16 ~10:48 AM ET (actual fill $70.15). Trailing activates at +10% ($77.17). Signal: Path F user watchlist. Roundhill Memory ETF — AI/memory semiconductor theme. YELLOW sizing (×0.75). HWM updated 2026-06-18 ~8:46 AM CDT (exchange print $75.40, +7.49% vs cost — new session HWM, still below +10% trailing threshold). |
