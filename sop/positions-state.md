...
|---|---|---|---|---|---|
| FCN | 156.90 | 156.90 | 133.37 | no | Filled 2026-06-16 at open. Below +10% threshold ($172.59), standard -15%-from-cost stop applies. Legacy exit rule: sell when price returns above $156.90. 7/6 10:13 AM CT: $153.29 (-0.20%). Recovering well from $151.59 open low; nearly flat. Hard stop $133.37 — $19.92 clear. Exit trigger $156.90 — $3.61 away. No trigger. 10-min watch active. |
