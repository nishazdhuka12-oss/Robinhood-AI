...
| FPS | 60.48 | 64.38 | 51.41 | no | Filled 2026-06-16 ~10:48 AM ET (actual fill $60.48). Trailing activates at +10% ($66.53). Signal: Path F user watchlist. Data center power equipment, 103% YoY growth. HWM updated 2026-06-17 ~2:06 PM CDT (exchange print $64.38, +6.45% vs cost — new session HWM). |
| DRAM | 70.15 | 72.33 | 59.63 | no | Filled 2026-06-16 ~10:48 AM ET (actual fill $70.15). Trailing activates at +10% ($77.17). Signal: Path F user watchlist. Roundhill Memory ETF — AI/memory semiconductor theme. YELLOW sizing (×0.75). HWM updated 2026-06-17 ~2:06 PM CDT (exchange print $72.33, +3.10% vs cost — new session HWM). |
